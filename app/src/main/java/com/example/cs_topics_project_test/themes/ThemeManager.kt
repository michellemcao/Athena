...
object ThemeManager {
    ...
    fun loadTheme(context: Context, themeName: String) {
        ...
        currentThemeColors = ThemeColors(
            ...
            backgroundCalendar = obj.getString("background_calendar").toColorInt(),
            backgroundTasks = obj.getString("background_tasks").toColorInt(),
            backgroundNotes = obj.getString("background_notes").toColorInt(),
            backgroundSettings = obj.getString("background_setting").toColorInt(),
            backgroundChat = obj.getString("background_chat").toColorInt(),
